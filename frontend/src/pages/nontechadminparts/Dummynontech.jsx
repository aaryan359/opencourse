...
const Dummynontech = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://opencoursebackend-j3sa.onrender.com/nontech/addnontechVideo', payload, {
        headers: {
    ...
    const fetchCourses = async () => {
      ...
      try {
        const response = await axios.get('https://opencoursebackend-j3sa.onrender.com/nontech/getnontechcourse');
