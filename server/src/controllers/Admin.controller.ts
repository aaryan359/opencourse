...
export const listFields = async (_req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to retrieve fields", statusCode: 500 });
    }
};
...
export const getDashboard = async (_req: AuthRequest, res: Response) => {
    try {
        const [
            ...
            ContributorApplication.countDocuments({ status: "pending" }),
        ]);
        ...
        const recentPendingVideos = await Video.find({ status: "pending" })
        ...
        return ApiResponse.success(res, {
            ...
            data: {
                stats: {
                    users: { total: totalUsers, students: totalStudents, contributors: totalContributors, admins: totalAdmins },
                    content: { courses: totalCourses, topics: totalTopics, videos: totalVideos },
                    videos: { pending: pendingVideos, approved: approvedVideos, rejected: rejectedVideos },
                    pendingApplications,
                },
                recentActivity: {
                    recentUsers,
        ...
        return ApiResponse.error(res, { message: "Failed to load dashboard", statusCode: 500 });
    }
};
...
export const listUsers = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to retrieve users", statusCode: 500 });
    }
};
...
export const getUserById = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to retrieve user", statusCode: 500 });
    }
};
...
export const changeUserRole = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.success(res, {
            ...
            data: { _id: targetUser._id, role: targetUser.role, contributorStatus: targetUser.contributorStatus },
        });
    } catch (error) {
        console.error("[admin.changeUserRole]", error);
        return ApiResponse.error(res, { message: "Failed to update user role", statusCode: 500 });
    }
};
...
export const listApplications = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to retrieve applications", statusCode: 500 });
    }
};
...
export const getApplicationById = async (req: AuthRequest, res: Response) => {
    try {
        ...
        if (!application) {
            return ApiResponse.error(res, { message: "Application not found", statusCode: 404 });
        }

        return ApiResponse.success(res, { data: application });
    } catch (error) {
        console.error("[admin.getApplicationById]", error);
        return ApiResponse.error(res, { message: "Failed to retrieve application", statusCode: 500 });
    }
};
...
export const approveApplication = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.success(res, {
            ...
            data: { applicationId: application._id, applicantId: application.applicant },
        });
    } catch (error) {
        console.error("[admin.approveApplication]", error);
        return ApiResponse.error(res, { message: "Failed to approve application", statusCode: 500 });
    }
};
...
export const rejectApplication = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to reject application", statusCode: 500 });
    }
};
...
export const listVideos = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to retrieve videos", statusCode: 500 });
    }
};
...
export const approveVideo = async (req: AuthRequest, res: Response) => {
    try {
        ...
        if (!video) {
            return ApiResponse.error(res, { message: "Video not found", statusCode: 404 });
        }

        if (video.status === "approved") {
            return ApiResponse.error(res, { message: "Video is already approved", statusCode: 409 });
        }

        video.status = "approved";
        video.reviewedBy = req.user!.userId as any;
        ...
        return ApiResponse.error(res, { message: "Failed to approve video", statusCode: 500 });
    }
};
...
export const rejectVideo = async (req: AuthRequest, res: Response) => {
    try {
        ...
        if (video.status === "rejected") {
            return ApiResponse.error(res, { message: "Video is already rejected", statusCode: 409 });
        }
        ...
        return ApiResponse.success(res, {
            ...
            data: { videoId: video._id, status: video.status, reviewNote: video.reviewNote },
        });
    } catch (error) {
        console.error("[admin.rejectVideo]", error);
        return ApiResponse.error(res, { message: "Failed to reject video", statusCode: 500 });
    }
};
...
export const deleteVideo = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.success(res, { message: "Video deleted permanently" });
    } catch (error) {
        console.error("[admin.deleteVideo]", error);
        return ApiResponse.error(res, { message: "Failed to delete video", statusCode: 500 });
    }
};
...
export const listCourses = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to retrieve courses", statusCode: 500 });
    }
};
...
export const createCourse = async (req: AuthRequest, res: Response) => {
    try {
        ...
        if (!fieldDoc) {
            return ApiResponse.error(res, { message: "Field not found", statusCode: 404 });
        }
        ...
        return ApiResponse.error(res, { message: "Failed to create course", statusCode: 500 });
    }
};
...
export const createTopic = async (req: AuthRequest, res: Response) => {
    try {
        ...
        if (!title?.trim()) {
            return ApiResponse.error(res, { message: "title is required", statusCode: 400 });
        }

        const course = await Course.findById(courseId);
        if (!course) {
            return ApiResponse.error(res, { message: "Course not found", statusCode: 404 });
        }

        // Auto-place at the end if order not provided
        let topicOrder = order;
        if (topicOrder === undefined) {
            const last = await Topic.findOne({ course: courseId }).sort({ order: -1 });
        ...
        return ApiResponse.error(res, { message: "Failed to create topic", statusCode: 500 });
    }
};
...
export const listContributors = async (req: AuthRequest, res: Response) => {
    try {
        ...
        return ApiResponse.error(res, { message: "Failed to retrieve contributors", statusCode: 500 });
    }
};
