  ...
  return (
    <div
      ...
      className={cn(
        ...
        "after:absolute after:content-[''] after:aspect-square after:w-[calc(var(--size)*1px)] after:[offset-distance:0%]",
        "after:[animation:border-beam_calc(var(--duration)*1s)_linear_infinite] after:[animation-delay:var(--delay)]",
