        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <button type="submit" className="animate-element animate-delay-600 w-full rounded-2xl bg-violet-600 py-4 font-medium text-white hover:bg-violet-500 transition-colors">
                Sign In
              </button>
            </form>
            ...
            <div className="animate-element animate-delay-700 relative flex items-center justify-center">
              ...
              <span className="px-4 text-sm text-neutral-400 bg-[#050506] absolute">Or continue with</span>
            </div>
