...
function StatCard({ icon: Icon, label, value }: { icon: React.ComponentType<any>; label: string; value: string }) {
  return (
    <div className="group relative p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.05] hover:border-white/[0.1] transition-all duration-300">
        ...
        <section className="min-h-[80vh] flex items-center py-20">
          <Container>
            <div className="text-center space-y-8 max-w-4xl mx-auto">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm group hover:border-white/[0.12] hover:bg-white/[0.05] transition-all">
              ...
              {/* CTA Button */}
              <div>
                <button className="px-8 py-4 rounded-xl bg-[#5E6AD2] text-white font-semibold hover:bg-[#6872D9] transition-all shadow-lg shadow-[#5E6AD2]/25 hover:shadow-xl hover:shadow-[#5E6AD2]/35 hover:scale-105 active:scale-95">
            ...
            <div className="space-y-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={idx}
                    className="p-8 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:bg-white/[0.04] hover:border-white/[0.1] transition-all duration-300 hover:scale-105"
                  >
          ...
          <Container>
            <div className="text-center space-y-8 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  className="px-8 py-4 rounded-xl bg-[#5E6AD2] text-white font-semibold hover:bg-[#6872D9] transition-all shadow-lg shadow-[#5E6AD2]/25 active:scale-95 hover:scale-105"
                >
                  Explore Courses
                </button>
                <button
                  className="px-8 py-4 rounded-xl border border-white/[0.1] text-white font-semibold hover:bg-white/[0.05] transition-all active:scale-95 hover:scale-105"
                >
                  Join Community
                </button>
              </div>
