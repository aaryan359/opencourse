				...
				<div className="relative z-10 pt-20 pb-15">
					...
					>
						<HoverBorderGradient
							...
							as="button"
							className="bg-neutral-950 from-indigo-400 text-white flex items-center space-x-2 px-4 py-1.5 text-xs"
						>
							<EyebrowLogo />
					...
					<div className="grid lg:grid-cols-2 gap-16 items-start">
						...
						>
							...
							<p className="mt-7 max-w-xl text-lg text-neutral-400 leading-relaxed">
								OpenCourse is a community-driven platform where developers continuously build,
								review, and refine courses and interview preparation — keeping knowledge relevant,
